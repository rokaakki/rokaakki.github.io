(function(){
	...
	,cc = $('<div class="wg"><style>.wg{position:absolute;z-index:250001;top:2px;left:2px}.wg button{opacity:0.7} .wg input{opacity:0.7}</style></div>').appendTo(document.body)
